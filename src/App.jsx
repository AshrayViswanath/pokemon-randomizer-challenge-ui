...
const GEN_RANGES = [
  ...
  { gen: "4", start: 387, end: 493 }, // per your instruction
    ...
    <div style={styles.app}>
      <header style={styles.header}>
        ...
        <p style={styles.subtle}>
          Enter a <strong>Target</strong> and choose a <strong>Generation</strong>. Each round,
          pick one hidden stat (no values shown) from HP, Attack, Defense, Sp. Atk, Sp. Def, Speed.
      ...
      {!startLocked && (
        <section style={styles.card}>
          ...
          <div style={styles.datasetNote}>
            Current dataset size: {POKEMON_LIST.length}. Filtering happens by the chosen range.
          </div>
        </section>
      )}
